...
export const siteConfig: SiteConfig = {
  ...
  favicon: [
    {
      // 图标文件路径
      src: "https://img.eysnter.cn/file/posts/icon/1780066744961_nav.png",
      // 可选，指定主题 'light' | 'dark'
      // theme: "light",
      // 可选，图标大小
      // sizes: "32x32",
  ...
  navbar: {
    ...
    logo: {
      type: "image",
      value: "assets/images/icon/zi-1.png",
      alt: "🍀",
    },
    // 导航栏标题
    title: "Eysnter",
  ...
  anime: {
    ...
    // TMDB 配置（可选，需要翻墙）
    // tmdb: {
    //   apiKey: "your_tmdb_api_key", // TMDB API 密钥
    //   listId: "your_list_id",       // TMDB 列表 ID
    // },
  },
  ...
  analytics: {
    // Google Analytics ID
    googleAnalyticsId: "G-T32ZYMC7LT",
  ...
  imageOptimization: {
    ...
    noReferrerDomains: ["*.hdslb.com", "*.bilibili.com", "image.tmdb.org"],
  },
